...
from ellie.tool_context import ToolContext
from ellie.tools import build_tool_registry, tool_delegate, tool_read_file


def test_tool_context_supports_file_tools_without_full_Ellie(tmp_path):
