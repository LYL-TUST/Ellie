...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Ellie agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-ellie starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-ellie" / "runs")
    return Ellie(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-ellie> ").strip()
